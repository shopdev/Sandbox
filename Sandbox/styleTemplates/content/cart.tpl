...
<div class="boxContent">
    <div class="cartProgress">
        <span {CLASS_CART}><img src="skins/Sandbox/styleImages/steps/stepShoppingCart.gif" alt="Shopping Cart" width="350" height="26" /></span>
        <span {CLASS_STEP2}><img src="skins/Sandbox/styleImages/steps/stepAddress.gif" alt="Address" width="350" height="26" /></span>
