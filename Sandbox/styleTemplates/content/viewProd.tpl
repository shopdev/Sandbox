    ...
    <div id="viewProdTop" class="clearfix">
            ...
            <tr>
              <td valign="middle" align="center" style="text-align:center;">
                  <a href="{IMG_SRC}" class="useLightbox" rel="group">
                    <img src="skins/Sandbox/php/getImg.php?src={IMG_SRC}&amp;width=320&amp;height=305" alt="{TXT_PRODTITLE}" border="0" title="{TXT_PRODTITLE}" />
                  </a>
              </td>
            </tr>
          </table>
        ...
        <div class="span-9 viewProdDetails">
            ...
            <div class="viewProdButtons">
                <a href="javascript:doAddToCart({PRODUCT_ID});" class="buyBtn singleBtn largeBtn">{BTN_ADDBASKET}<img src="skins/Sandbox/styleImages/backgrounds/buttonArrow.gif" alt="" /></a>
            </div>
            <!-- END: buy_btn -->
