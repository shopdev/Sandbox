...
<link href="skins/{VAL_SKIN}/php/compress.php?get=../styleSheets/grid.css||../styleSheets/layout.css" rel="stylesheet" type="text/css" />
<script type="text/javascript">
	var rootRel = "{VAL_ROOTREL}";
</script>
<script type="text/javascript" language="javascript" src="skins/{VAL_SKIN}/php/compress.php?get=../javascript/jslibrary.js||../javascript/jquery-1.3.2.min.js||../javascript/noConflict.js||../javascript/cookie.js||../javascript/shopdev_effects.js"></script>
<!-- Insert Prototype library here if required by 3rd party modifications -->
</head>
...
<div id="pageSurround" class="container">
	<div id="topHeader" class="clearfix">
        <div class="span-28">
            <a href="index.php"><img src="images/getLogo.php?skin=Sandbox_Light" alt="Home" /></a>
        </div>
    ...
    <div class="pageBorder">
        ...
        <div id="page" class="clearfix">
            ...
            <div class="colMid span-25 prepend-1">
                {PAGE_CONTENT}
            </div>
         </div>
	</div>
