...
<div class="boxContent">
	<div class="cartProgress">
        <span><img src="skins/Sandbox_Light/styleImages/steps/stepShoppingCart.gif" alt="Shopping Cart" width="350" height="26" /></span>
        <span><img src="skins/Sandbox_Light/styleImages/steps/stepAddress.gif" alt="Address" width="350" height="26" /></span>
        <span><img src="skins/Sandbox_Light/styleImages/steps/stepPayment.gif" alt="Payment" width="350" height="26" /></span>
        <span class="txtcartProgressCurrent"><img src="skins/Sandbox_Light/styleImages/steps/stepComplete.gif" alt="Complete" width="350" height="26" /></span>
    </div>
    <!-- BEGIN: order_success -->
