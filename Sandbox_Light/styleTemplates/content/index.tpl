			...
			<div class="span-8" style="width:208px;">
                <div class="latestProds">
                        ...
                        <tr>
                            <td valign="middle" align="center" style="text-align:center;">
                                <a href="index.php?_a=viewProd&amp;productId={VAL_PRODUCT_ID}">
                                    <img src="skins/Sandbox_Light/php/getImg.php?src={VAL_IMG_SRC}&amp;width=178&amp;height=130" alt="{VAL_PRODUCT_NAME}" border="0" title="{VAL_PRODUCT_NAME}" />                    				
                                </a>
                            </td>
                        </tr>
                  	</table>
                    <div class="latestProdDetails">
                        ...
                        <div class="buttons">
                            <form action="skins/Sandbox_Light/php/ajaxCart.php" method="post" name="prod{VAL_PRODUCT_ID}" id="myForm{VAL_PRODUCT_ID}">
