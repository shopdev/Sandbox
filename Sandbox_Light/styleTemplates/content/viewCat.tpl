        ...
        <table border="0" align="center" cellpadding="0" cellspacing="0">
            <tr>
                <td valign="middle" align="center" style="text-align:center;">
                    ...
                    <img src="skins/Sandbox_Light/php/getImg.php?src={IMG_CATEGORY}&amp;width=159&amp;height=130" alt="{TXT_CATEGORY}" border="0" title="{TXT_CATEGORY}" />
                    </a>
                </td>
            </tr>
        </table>
  ...
  <div class="latestProdsContainer clearfix">
    ...
    <div class="span-8" style="width:208px;">
      <div class="latestProds">
        ...
        <table border="0" align="center" cellpadding="0" cellspacing="0">
          <tr>
            <td valign="middle" align="center" style="text-align:center;"><a href="index.php?_a=viewProd&amp;productId={PRODUCT_ID}"> <img src="skins/Sandbox_Light/php/getImg.php?src={SRC_PROD_THUMB}&amp;width=178&amp;height=130" alt="{TXT_TITLE}" border="0" title="{TXT_TITLE}" /> </a> </td>
          </tr>
        </table>
        <div class="latestProdDetails">
          ...
          <form action="skins/Sandbox_Light/php/ajaxCart.php" method="post" name="prod{PRODUCT_ID}" id="myForm{PRODUCT_ID}">
            <input type="hidden" name="add" value="{PRODUCT_ID}" />
            <input type="hidden" name="quan" value="1" />
            <input type="hidden" name="opt" value="1" />
            <input type="hidden" name="page" value="viewCat" />
            <div class="buttons">
                <!-- BEGIN: buy_btn --><a href="javascript:doAddToCart({PRODUCT_ID});" title="{BTN_BUY}" class="buyBtn">ADD TO CART<img src="skins/Sandbox_Light/styleImages/backgrounds/buttonArrow.gif" alt="" /></a><!-- END: buy_btn --><a href="index.php?_a=viewProd&amp;productId={PRODUCT_ID}" title="{TXT_TITLE}" class="moreBtn">MORE<img src="skins/Sandbox_Light/styleImages/backgrounds/buttonArrow.gif" alt="" /></a>
            </div>
          </form>
        </div>
      </div>
