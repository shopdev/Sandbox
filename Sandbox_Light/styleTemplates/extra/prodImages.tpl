...
<body>
    ...
    <ul class="gallery_demo_unstyled">
        <!-- BEGIN: thumbs -->
            <li><a href="skins/{VAL_SKIN}/php/getImg.php?src={VALUE_SRC}&amp;width=700&amp;height=438"><img src="skins/{VAL_SKIN}/php/getImg.php?src={VALUE_SRC}&amp;width=68&amp;height=50&amp;fill=1" alt="{ALT_THUMB}"></a></li>
        <!-- END: thumbs -->
    </ul>
